...
import { cancelExpenseAction } from "@/modules/expenses/actions";
              ...
              {entries.map((entry) => (
                <TableRow key={entry.id}>
                  <TableCell className="font-medium">
                    <Link href={`/despesas/${entry.id}`} className="hover:underline">
                      {entry.description}
                    </Link>
                  </TableCell>
                  ...
                  <TableCell>
                    <Badge variant={badgeVariant(entry)}>
                      {getEntrySituationLabel("EXPENSE", entry)}
                    </Badge>
                  </TableCell>
                  <TableCell className="text-right">
                    {!entry.cancelledAt && (
                      <CancelEntryButton
                        entryId={entry.id}
                        cancelAction={cancelExpenseAction}
                      />
                    )}
                  </TableCell>
                </TableRow>
